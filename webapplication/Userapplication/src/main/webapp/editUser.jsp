...
<div class="container">
    ...
    <div class="info">
        <strong>Editing user:</strong> <%= editUser.getUsername() %>
    </div>
    ...
    <form method="POST" action="<%=request.getContextPath()%>/editUser">
        ...
        <div class="form-group">
            ...
            <input type="text" id="username_display" value="<%= editUser.getUsername() %>" readonly>
        </div>
        
        <div class="form-group">
            <label for="fullName">Full Name *</label>
            <input type="text" id="fullName" name="fullName" value="<%= editUser.getFullName() %>" required placeholder="Enter full name">
        </div>
        
        <div class="form-group">
            <label for="email">Email *</label>
            <input type="email" id="email" name="email" value="<%= editUser.getEmail() %>" required placeholder="Enter email address">
        </div>
